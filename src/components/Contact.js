...
// icons
import { FaRegStar, FaStar, FaCheckCircle , FaCheck } from "react-icons/fa";
    ...
    <>
      <Row>
        ...
        >
          ...
          <div className="icon" onClick={() => updateActContact()}>
            {contact.active ? (
        ...
        <Col md="8" onClick={() => viewSingleContact(contact)}>
          ...
          <div className="text-info">{contact.createdAt}</div>
        </Col>
        <Col
          md="1"
          className="d-flex justify-content-center align-items-center"
